  ...
  return (
    <div className="mx-4 md:mx-10 mt-10 md:mt-40 mb-20">
      <div className="flex items-end mb-10 md:mb-20 flex-wrap">
        <div className="flex flex-col w-[90%] md:w-[60%] h-[20vh] md:h-[30vh] justify-end">
          <h1 className="w-full text-5xl md:text-8xl">OUR</h1>
          <h1 className="w-full text-5xl md:text-8xl">PROJECTS</h1>
        </div>
        <p className="w-full md:w-[30%] text-base md:text-lg mt-4 md:mt-0">
